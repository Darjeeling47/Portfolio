    ...
    <div className="bg-white dark:bg-black dark:border-b dark:border-gray-500 dark:glow top-0 right-0 left-0 fixed flex w-screen items-center z-[100] shadow-sm">
      <div className="container mx-auto py-2 h-12 hidden md:flex flex-row justify-between">
        ...
        <div
          ...
          className="cursor-pointer align-middle border dark:border-gray-500 h-8 w-8 flex items-center justify-center aspect-square rounded-full justify-self-end ml-5 self-center hover:text-white hover:bg-blue-500 transition-all duration-100"
        >
          {theme == "dark" ? (

...
export default function ProjectImage({
  ...
  return (
    <>
      ...
      {isShow && (
        <div
          className="fixed inset-0 bg-background/30 dark:bg-background-dark/30 backdrop-blur z-[101] flex flex-col items-center justify-between px-1 lg:px-10 w-screen"
